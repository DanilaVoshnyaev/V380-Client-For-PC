...
MESSAGES = {
    "en": {
        ...
        "arg_scan": "sweep a whole subnet: an address like 192.168.1.0/24, or \"auto\" to detect your own network",
        "arg_i_own_this": "confirm you own or are authorised to scan a non-private address",
        "scan_auto_detected": "Your network detected automatically: %s",
        "scan_auto_failed": "Could not detect your network (found: %s). Pass the subnet explicitly, e.g. --scan 192.168.1.0/24",
        "scan_not_private": "%s is not a private network — it is someone else’s host on the internet. This tool is for your own network. If you genuinely own it, repeat with --i-own-this.",
        ...
        "arg_report_html": "save an HTML survey report to this file",

        # --- отчёт по объекту (HTML) ---
        "rh_title": "Camera survey",
        "rh_subtitle": "Network %s · %s",
        "rh_summary": "Summary",
        "rh_total": "Cameras found",
        "rh_ready": "Stream already available",
        "rh_can_free": "Can be freed from the cloud",
        "rh_locked": "No standard way in",
        "rh_others": "Other devices on the network (not cameras): %d",
        "rh_devices": "Devices",
        "rh_col_addr": "Address",
        "rh_col_model": "Model",
        "rh_col_state": "State",
        "rh_col_action": "What can be done",
        "rh_act_ready": "Ready to connect",
        "rh_act_enable": "Enable ONVIF in the vendor app — then it works without the cloud",
        "rh_act_setup": "Needs configuration",
        "rh_act_locked": "Vendor app or firmware change only",
        "rh_urls": "Working stream URLs",
        "rh_urls_note": "These addresses work in VLC, Home Assistant, Frigate, Blue Iris and Agent DVR.",
        "rh_security": "Security",
        "rh_sec_open": "Cameras serving video with no password at all: %d",
        "rh_sec_note": "Anyone on this local network can watch those streams. Do not forward camera ports to the internet — use a VPN for remote access.",
        "rh_disclaimer": "Survey of the customer’s own equipment, carried out with the customer’s permission. Read-only: nothing was changed on the devices.",
        "rh_footer": "Generated by %s %s · %s",
        "rh_saved": "Report saved: %s",
    },
    ...
    "ru": {
        ...
        "arg_scan": "обойти подсеть: адрес вида 192.168.1.0/24 либо \"auto\" — определить свою сеть самому",
        "arg_i_own_this": "подтвердить право сканировать неприватный адрес",
        "scan_auto_detected": "Ваша сеть определена автоматически: %s",
        "scan_auto_failed": "Не удалось определить вашу сеть (найдено: %s). Укажите подсеть явно, например --scan 192.168.1.0/24",
        "scan_not_private": "%s — не приватная сеть, это чужой узел в интернете. Инструмент предназначен для вашей собственной сети. Если адрес действительно ваш, повторите с --i-own-this.",
        ...
        "arg_report_html": "сохранить HTML-отчёт по объекту в указанный файл",

        # --- отчёт по объекту (HTML) ---
        "rh_title": "Обследование камер",
        "rh_subtitle": "Сеть %s · %s",
        "rh_summary": "Сводка",
        "rh_total": "Камер найдено",
        "rh_ready": "Поток уже доступен",
        "rh_can_free": "Можно освободить от облака",
        "rh_locked": "Штатных способов нет",
        "rh_others": "Прочих устройств в сети (не камеры): %d",
        "rh_devices": "Устройства",
        "rh_col_addr": "Адрес",
        "rh_col_model": "Модель",
        "rh_col_state": "Состояние",
        "rh_col_action": "Что можно сделать",
        "rh_act_ready": "Готово к подключению",
        "rh_act_enable": "Включить ONVIF в приложении вендора — и камера заработает без облака",
        "rh_act_setup": "Требуется настройка",
        "rh_act_locked": "Только приложение вендора либо смена прошивки",
        "rh_urls": "Рабочие адреса потоков",
        "rh_urls_note": "Эти адреса принимают VLC, Home Assistant, Frigate, Blue Iris и Agent DVR.",
        "rh_security": "Безопасность",
        "rh_sec_open": "Камер, отдающих видео вообще без пароля: %d",
        "rh_sec_note": "Эти потоки может смотреть любой, кто находится в этой локальной сети. Не пробрасывайте порты камер наружу — для удалённого доступа используйте VPN.",
        "rh_disclaimer": "Обследование собственного оборудования заказчика, выполнено с его разрешения. Только чтение: на устройствах ничего не изменялось.",
        "rh_footer": "Отчёт подготовлен %s %s · %s",
        "rh_saved": "Отчёт сохранён: %s",
    },
}
